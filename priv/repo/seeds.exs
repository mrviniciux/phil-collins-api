...
albums_data = [
  %{title: "No Jacket Required", release_date: ~D[1985-02-18], is_lp: true, image: "no_jacket_required.jpg"},
  %{title: "Invisible Touch", release_date: ~D[1986-06-06], is_lp: true, image: "invisible_touch.jpg"},
